...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://gouravbolange_db_user:yos9d73FCsyLpiI6@cluster0.wxnzgc0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/vj_bot_disscussion',False)
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/vj_botz',False)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vj_bot_disscussion',False) # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/kingvj01',False)
